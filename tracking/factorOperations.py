...
def joinFactors(factors: List[Factor]):
    ...
    # Step 1. Initiate new conditioned and unconditioned list
    ...
    # Step 2. Remove all repetitions and convert to list
    conditioned.difference_update(unconditioned)
    conditioned = list(conditioned)
    unconditioned = list(unconditioned)

    # Step 3. Create new factor
    joinedFactor = Factor(unconditioned, conditioned, domainDict)

    # Step 4. Assign new probabilities
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        unconditioned = [f for f in factor.unconditionedVariables() if f != eliminationVariable]
        eliminatedFactor = Factor(unconditioned, conditioned, domain)

        # Step 2. Assign new probability
